...
try:
    ...
    ENHANCED_MULTILINGUAL_AVAILABLE = True
except ImportError:
    ENHANCED_MULTILINGUAL_AVAILABLE = False
    logger.warning("Enhanced multilingual processor not available")
...
class EnhancedMultilingualDocumentLoader:
    ...
    def __init__(self, 
        ...
        Args:
            ...
            chunk_overlap: Overlap between chunks
        """
        if not ENHANCED_MULTILINGUAL_AVAILABLE:
            raise ImportError("Enhanced multilingual processor not available. Install required dependencies.")
...
def create_document_loader(chunk_size: int = 1000, 
    ...
    """
    if multilingual:
        if enhanced and ENHANCED_MULTILINGUAL_AVAILABLE:
